...
z *= Q_('meter')
c = 0.7988011771096981                                               #Chord wise postion in ratio
...
perim_coords = np.genfromtxt("../Structures/get_xy_from_perim.dat", skip_header=1)
...
perim_coords = np.genfromtxt("../Structures/get_xy_from_perim_inv.dat", skip_header=1)
perims = perim_coords[:,0]
x_cs = perim_coords[:,1]
y_cs = perim_coords[:,2]
