...
def trim():
    ...
    result = optimize.minimize(trimlift, initial_guess, method='POWELL', bounds=angle_bound,
                               options={'ftol': 0.001, 'xtol': 0.00001})
...
#    Mxlst.append(Mx.magnitude)
#
# plt.plot(tlst,plst,label='roll rate',c='black')
# plt.plot(tlst,Mxlst,label='moment due to roll')
