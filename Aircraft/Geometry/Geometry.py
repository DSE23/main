...
class H_tail(object):
    ...
    S = Q_("2.0m**2")                 # [m^2] Horizontal tail surface
    A = 2.86                  # Aspect ratio
    ...
    X_h = Q_("5.2 m")                  # [m] LE location compared to the nose
...
class V_tail(object):
    ...
    S = Q_("1.67 m**2")                                    # [m^2] V-tail surface area
    A = 0.99                                    # Aspect ratio
...
class CG(object):
    ...
    XLEMAC = Q_("1.10 m")               # LEMAC position
